...
internal enum Asset {
  ...
  internal enum Colors {
    internal enum Grayscale {
      ...
      internal static let _90 = ColorAsset(name: "90")
    }
    internal static let levelBorder = ColorAsset(name: "level_border")
  ...
  internal enum Images {
    ...
    internal static let moduleText = ImageAsset(name: "module_text")
    internal static let moduleVideo = ImageAsset(name: "module_video")
    internal static let navBackButton = ImageAsset(name: "nav_back_button")
    internal static let selectedCellInwardArrow = ImageAsset(name: "selected_cell_inward_arrow")
    internal static let selectedCellOutwardArrow = ImageAsset(name: "selected_cell_outward_arrow")
    internal static let spend = ImageAsset(name: "spend")
    internal static let tile = ImageAsset(name: "tile")
  }
}
